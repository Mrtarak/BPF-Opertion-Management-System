...
class StudentGoalsModel extends Model
{
    ...
    {
         return $this->select('student_goals.*, student.First_Name, student.Last_Name, goaltype_m.Goal_Type_Name')
            ->join('student', 'student.Student_Id = student_goals.Student_Id')
            ->join('goaltype_m', 'goaltype_m.Goal_Type_Id = student_goals.Goal_Type_Id')
