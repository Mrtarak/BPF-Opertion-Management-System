        ...
        <div class="col-12 grid-margin stretch-card">
          ...
          <?= view('includes/breadcrumb'); ?>
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="card-title mb-0">Doosra Mauka List</h4>
                <div class="d-flex align-items-center">
                    ...
                    <a href="<?= site_url('students/doosra_mauka/add') ?>" class="btn btn-primary btn-sm">
                        <i class="mdi mdi-plus-circle-outline me-1"></i> Add Doosra Mauka
                    </a>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="doosraMaukaTable" class="table table-bordered table-striped">
<thead>
    <tr>
        <th>#</th>
        <th>Full Name</th>
    ...
    <?php if (!empty($students)): ?>
        <?php $i = 1; foreach ($students as $stu): ?>
            <tr>
                ...
                <td>
                    <a href="<?= site_url('students/doosra_mauka/view/' . $stu['Student_Id']) ?>" class="btn btn-info btn-sm" title="View"><i class="mdi mdi-eye"></i></a>
                    <a href="<?= site_url('students/doosra_mauka/edit/' . $stu['Student_Id']) ?>" class="btn btn-warning btn-sm" title="Edit"><i class="mdi mdi-pencil"></i></a>
                    <a href="<?= site_url('students/doosra_mauka/delete/' . $stu['Student_Id']) ?>" onclick="return confirm('Are you sure?')" class="btn btn-danger btn-sm" title="Delete"><i class="mdi mdi-delete"></i></a>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else: ?>
...
$(document).ready(function() {
    var table = $('#doosraMaukaTable').DataTable({
        paging: true,
        searching: true,
        ordering: true,
        info: true,
