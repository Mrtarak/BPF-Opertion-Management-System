    ...
    <?= view('includes/sidebar'); ?>
        ...
        <div class="main-panel">
          ...
          <?= view('includes/breadcrumb'); ?>
            ...
            <form id="editStudentForm" action="<?= site_url('students/learning_adda/edit') ?>" method="post" enctype="multipart/form-data" id="editStudentForm">
...
<div class="tab-pane fade" id="program">
    <div class="row">
        <div class="col-md-6 mb-3">
            <label>Program </label>
            <input type="text" class="form-control" name="Program_Name" value="Learning Adda" readonly>
        </div>
        <div class="col-md-6 mb-3">
...
<div class="d-flex justify-content-between">
  ...
  <div class="mt-4 d-flex justify-content-center flex-wrap gap-3">
                    <a href="<?= site_url('students/learning_adda') ?>" class="btn btn-light">Cancel</a>
