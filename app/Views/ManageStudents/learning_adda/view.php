  ...
  <div class="content-wrapper">
    <div class="card">
      <div class="card-body">
        ...
        <h4 class="card-title">Learning Adda - Student Details</h4>
        ...
        <div class="mt-3">
          <a href="<?= site_url('students/learning_adda/edit/'.$student['Student_Id']) ?>" class="btn btn-primary">Edit</a>
          <a href="<?= site_url('students/learning_adda') ?>" class="btn btn-secondary">Back</a>
        </div>
