    ...
    <?= view('includes/sidebar'); ?>
        ...
        <div class="main-panel">
          ...
          <?= view('includes/breadcrumb'); ?>
            ...
            <form id="editStudentForm" action="<?= site_url('students/vijetaas/goals/edit') ?>" method="post" enctype="multipart/form-data" id="editStudentForm">
...
<div class="tab-pane fade" id="program">
    <div class="row">
        <div class="col-md-6 mb-3">
            <label>Program </label>
            <input type="text" class="form-control" name="Program_Name" value="Vijetaas" readonly>
        </div>
        <div class="col-md-6 mb-3">
