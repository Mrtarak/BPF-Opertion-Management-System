  ...
  <div class="content-wrapper">
    <div class="card">
      <div class="card-body">
        ...
        <div class="mt-3">
          <a href="<?= site_url('students/vijetaas/edit/'.$student['Student_Id']) ?>" class="btn btn-primary">Edit</a>
          <a href="<?= site_url('students/vijetaas') ?>" class="btn btn-secondary">Back</a>
        </div>
