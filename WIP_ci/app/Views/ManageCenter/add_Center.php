...
<p class="card-description">Add Center</p>
...
<form class="forms-sample" action="<?= site_url('center/store') ?>" method="post">
  <div class="row">
    ...
    <div class="col-md-6 form-group">
      ...
      <input type="text" name="Center_Coordinator" class="form-control" value="<?= old('Center_Coordinator') ?>" placeholder="Enter Center Coordinator" >
    </div>
    ...
    <div class="col-md-6 form-group">
      ...
      <input type="number" name="Center_Head_Contact" class="form-control" value="<?= old('Center_Head_Contact') ?>">
    </div>
