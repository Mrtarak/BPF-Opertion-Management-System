...
<div class="container-fluid page-body-wrapper">
  ...
  <a href="<?php echo base_url('goals/add'); ?>" class="btn btn-primary btn-sm">
                                ...
                                <?php if (!empty($goals)): ?>
                                    <?php $i = 1; foreach ($goals as $g): ?>
                                        <tr>
                                            ...
                                            <td>
                              <a href="<?= base_url('goals/view/' . $g['Program_Id']) ?>" class="btn btn-info btn-sm">
                                <i class="mdi mdi-eye"></i>
                              </a>
                              <a href="<?= base_url('goals/edit/' . $g['Program_Id']) ?>" class="btn btn-warning btn-sm">
